                    ...
                    public void onDecoded(@NonNull final Result result) {
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                _result = result;
                                firebaseEvent.child(_result.toString()).child("people").child(me.getUid()).setValue("Guest");

                                firebaseUser.child(me.getUid()).child("user-events").child(_result.toString()).setValue(snapshot.child(result.toString()).child("name").getValue(String.class));
                            }
                        });
                    }
                });
